 ...
 * secondary button.
 * @property numButtons The number of buttons in the button group.
 * @property firstButtonModel The button metadata for the first button.
 * @property secondButtonModel The button metadata for the second button.
 */
class ButtonGroupUiModel(
    ...
    val numButtons: Int,
    val firstButtonModel: ButtonDataModel,
    val secondButtonModel: ButtonDataModel
)