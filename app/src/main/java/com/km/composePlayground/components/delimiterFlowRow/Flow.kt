...
/*
 * FlowLayout was originally part of the Compose framework until it was deemed unnecessary.
 * This is a copy of the code from 1/12/2021
 *
 */
...
internal data class OrientationIndependentConstraints(
  ...
  fun stretchCrossAxis(): OrientationIndependentConstraints = OrientationIndependentConstraints(
    mainAxisMin,
    mainAxisMax,
  ...
  fun toBoxConstraints(orientation: LayoutOrientation): Constraints =
  ...
  fun maxWidth(orientation: LayoutOrientation): Int =
    if (orientation === LayoutOrientation.Horizontal) {
      mainAxisMax
    } else {
      crossAxisMax
  ...
  fun maxHeight(orientation: LayoutOrientation): Int =
    if (orientation === LayoutOrientation.Horizontal) {
      crossAxisMax
    } else {
      mainAxisMax
